...
LOG_GROUP_ID = int(getenv("LOG_GROUP_ID", -1002718304246))
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/saregamamusic/Billi-Music",
)
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHAT", "https://t.me/SN8SUPPORT")
SUPPORT_GROUP = getenv("SUPPORT_GROUP", "https://t.me/GHOULS_SUPPORT")
...
START_IMG_URL = getenv(
    "START_IMG_URL", "https://files.catbox.moe/tewqls.jpg"
)
PING_IMG_URL = getenv(
    "PING_IMG_URL", "https://files.catbox.moe/bwtbji.jpg"
)
